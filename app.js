...
const titreIndependants = document.getElementById('titreIndependants');
const titreNonIndependants = document.getElementById('titreNonIndependants');
...
fetch(url)
    ...
    .then(function(data) {
        ...
        // Afficher les titres et les listes de pays après le chargement des données
        titreIndependants.style.display = 'block';
        titreNonIndependants.style.display = 'block';
        divPaysIndependants.style.display = 'flex';
        divPaysNonIndependants.style.display = 'flex';
    ...
    fetch('https://restcountries.com/v3.1/all')
        ...
        .then(function(data) {
            ...
            if (pays) {
                ...
                titreIndependants.style.display = 'none';
                titreNonIndependants.style.display = 'none';
